...
flags.DEFINE_float(name='plpd_threshold', default=1e-4, help='Threshold value for the PLPD filter.')
flags.DEFINE_float(name='deyo_margin', default=2.0, help='Margin parameter used in the DeYO method.')
flags.DEFINE_integer(name='size', default=15, help='Grid size for SOM.')
flags.DEFINE_integer(name='filter_ent', default=1, help='Flag to enable (1) or disable (0) entropy-based filtering.')
flags.DEFINE_integer(name='filter_plpd', default=1, help='Flag to enable (1) or disable (0) PLPD-based filtering.')
flags.DEFINE_integer(name='gap', default=1, help='Interval or gap between processing steps.')
flags.DEFINE_integer(name='patch_size', default=20, help='Size of the image patches for processing.')
flags.DEFINE_integer(name='cache_len', default=10, help='Maximum length of the memory cache.')
flags.DEFINE_float(name='som_lr', default=0.05, help='Learning rate for training SOM.')
flags.DEFINE_integer(name='som_iter', default=100, help='Number of training iterations for the SOM.')
flags.DEFINE_float(name='vis_weight', default=0.2, help='Weight parameter applied to the visual logits.')
flags.DEFINE_integer(name='som_sigma', default=2, help='Neighborhood radius for the SOM.')
